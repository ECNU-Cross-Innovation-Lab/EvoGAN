...
class Options(object):
    ...
    def initialize(self):
        ...
        # EC
        parser.add_argument('--pc_k', type=float, default=0.7, help='cross rate')
        parser.add_argument('--pm_k', type=float, default=0.02, help='mutation rate')
        parser.add_argument('--gene_length', type=int, default=17, help='gene length')
        parser.add_argument('--life_count', type=int, default=20, help='life count')
        parser.add_argument('--generation_count', type=int, default=20, help='iter count')

        parser.add_argument('--mode', type=str, default='test', help='Mode of code. [train|test]')
        parser.add_argument('--model', type=str, default='ganimation', help='[ganimation|stargan], see GANmodel.__init__ from more details.')
        ...
        parser.add_argument('--interpolate_len', type=int, default=10, help='interpolate length for test.')
        ...
        parser.add_argument('--loaded_dataset', type=str, default="celeba", help='loaded dataset')
        parser.add_argument('--data_root', type=str, default="dataset", help='paths to GANdata set.')
        ...
        parser.add_argument('--n_threads', type=int, default=1, help='number of workers to load GANdata.')
        parser.add_argument('--max_dataset_size', type=int, default=150, help='maximum number of samples.')
        ...
        parser.add_argument('--epoch_count', type=int, default=1, help='the starting epoch count, we save the GANmodel by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
